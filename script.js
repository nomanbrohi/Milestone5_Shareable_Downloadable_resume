document.addEventListener('DOMContentLoaded', function () {
    ...
    var downloadCvButton = document.getElementById('downloadCv'); // New download button
    ...
    form.addEventListener('submit', function (event) {
        ...
        educationInstitutions.forEach(function (institution, index) {
            ...
            var institutionHeading = document.createElement('h5');
        ...
        var editaleButton = document.getElementById('editCv');
        editaleButton.addEventListener("click", function () {
            cv.classList.add('none');
            cvmaindiv.classList.remove('none');
            editCvButton.classList.add('none');
        });
        downloadCvButton.addEventListener('click', function () {
            var cvElement = document.getElementById('cv'); // The div containing the CV content
